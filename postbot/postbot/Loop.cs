namespace postbot
{
   internal class Loop
   {
      ...
      public Loop(int id, string id_user, string id_chanels, string name, string posts, string time_interval, string last_send, string last_post, string process, string time_off)
      {
         this.id = id;
